...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const next = new URLSearchParams(window.location.search).get('next') ?? '/global';
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 rounded-lg border border-zinc-200 text-sm text-zinc-900 bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                placeholder="••••••••"
              />
              <button
                type="button"
