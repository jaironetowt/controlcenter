  ...
  return (
    <div ref={setNodeRef} style={style} className="group bg-white rounded-xl border border-orange-300 overflow-hidden">
      ...
      <div
        {...attributes}
        {...listeners}
        className="flex items-center justify-center h-0 group-hover:h-5 overflow-hidden cursor-grab active:cursor-grabbing transition-all duration-150 group-hover:delay-1000 bg-zinc-50 border-b border-zinc-100 touch-none"
