        ...
        {selected !== 'reminder' && (() => {
          ...
          return (
            <button
              ...
              className="w-20 flex-shrink-0 flex items-center justify-center px-2 py-1 rounded-lg text-[10px] font-medium border bg-white text-zinc-500 transition-colors focus:outline-none hover:opacity-80 tracking-tight"
