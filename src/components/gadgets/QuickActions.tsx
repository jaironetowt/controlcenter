        ...
        {selected !== 'reminder' && (() => {
          ...
          return (
            <button
              ...
              className="flex-1 min-w-0 flex items-center justify-center px-2 py-1 rounded-lg text-[9px] font-semibold border bg-white text-zinc-500 transition-colors focus:outline-none hover:opacity-80 tracking-tight"
