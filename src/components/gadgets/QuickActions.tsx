        ...
        {selected !== 'reminder' && (() => {
          ...
          return (
            <button
              ...
              className="flex-1 min-w-0 flex items-center gap-1.5 px-2 py-1 rounded-lg text-[11px] font-medium border bg-white text-zinc-600 transition-colors focus:outline-none hover:opacity-80"
