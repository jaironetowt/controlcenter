  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <textarea
        ...
        className="w-full text-[13px] bg-[#F9F9FA] border border-zinc-200 rounded-lg p-3 resize-none focus:outline-none focus:ring-1 focus:ring-blue-300 placeholder:text-zinc-400 text-zinc-800"
      />
      {value && (
        <button
          onClick={() => setValue('')}
